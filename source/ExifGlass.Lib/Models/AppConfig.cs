...
public sealed class AppConfig
{
    ...
    /// <summary>
    /// Optional explicit path to the ExifTool executable; empty uses the bundled/PATH copy.
    /// </summary>
    public string ExifToolPath { get; set; } = "";

    /// <summary>
    /// Extra command-line arguments appended to every ExifTool invocation.
    /// </summary>
    public string ExifToolArguments { get; set; } = "";

    /// <summary>
    /// Whether the footer shows the live ExifTool command preview.
    /// </summary>
    ...
    /// <summary>
    /// UTC timestamp of the last update check (ISO-8601), or empty if never.
    /// </summary>
    public string LastUpdateCheck { get; set; } = "";

    /// <summary>
    /// Returns a shallow copy so callers can mutate without touching the live instance.
    /// </summary>
