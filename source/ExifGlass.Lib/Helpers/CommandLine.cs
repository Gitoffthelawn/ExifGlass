...
public static class CommandLine
{
    ...
    public static StartupOptions Parse(IReadOnlyList<string> args)
    {
        ...
        foreach (var raw in args)
        {
            ...
            // ImageGlass 10 pipe flag: "--pipe" or "--pipe=<name>".
            ...
            // ImageGlass 9 external-tool flag: "--ig-tool-pipe-code=<code>".
            if (raw.StartsWith(ImageGlass9PipeCodeFlag, StringComparison.OrdinalIgnoreCase))
            {
                mode = AppMode.ImageGlass9;
                continue;
            }
